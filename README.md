...
On the other hand, Erlang/OTP is built exactly for handling those chaotic scenarios and be highly available and massively scalable.As they say, every cloud service is bad and incomplete implementation of Erlang/OTP. Erlang/OTP is that good.Python may never achieve that level of scalability, but trying to borrow that super powers from erlang/OTP is an endeavour worth taking.
